...
const translations = {
  en: {
    ...
    "proj.aaaf": "A friendly space to ask questions and connect with the Adventist community.",
    "proj.quinoa": "A plant-based recipes and lifestyle mobile app.",
    "proj.hymnal": "A digital hymnal you can browse anywhere.",
    "proj.gym": "A workout companion to plan and track gym sessions.",
  ...
  es: {
    ...
    "proj.aaaf": "Un espacio amigable para hacer preguntas y conectar con la comunidad adventista.",
    "proj.quinoa": "Una app móvil de recetas y estilo de vida basado en plantas.",
    "proj.hymnal": "Un himnario digital que puedes consultar donde sea.",
    "proj.gym": "Un compañero de entrenamiento para planificar y registrar tus rutinas.",
